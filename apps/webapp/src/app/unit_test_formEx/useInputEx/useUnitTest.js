 ...
 * ╔═══════════════════════════════════════════════════════════════╗
 * ║                                                               ║
 * ║   MetroJS - useInputEx Unit Test Hook                          ║
 * ║   Copyright (c) 2024 Metro Digital Solutions                  ║
 * ║                                                               ║
 * ║   useInputExコンポーネントのテスト用カスタムフック                    ║
 * ║                                                               ║
 * ╚═══════════════════════════════════════════════════════════════╝
 *
 * このファイルはuseInputExコンポーネントのテストページで使用される
 * カスタムフックを定義します。フォーム管理、API実行、コピー機能などを提供します。
 *
 * @file useUnitTest.js
 * @module unit_test/useInputEx/useUnitTest
 */
...
const log = new logjs("unit_test_formEx/useInputEx/useUnitTest");
const api = new apijs("api/test");

/**
 * useInputExのテスト用カスタムフック
