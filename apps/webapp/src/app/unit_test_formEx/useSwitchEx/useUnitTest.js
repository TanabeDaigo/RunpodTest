 ...
 * ╔═══════════════════════════════════════════════════════════════╗
 * ║                                                               ║
 * ║   MetroJS - useSwitchEx Unit Test Hook                          ║
 * ║   Copyright (c) 2024 Metro Digital Solutions                  ║
 * ║                                                               ║
 * ║   useSwitchExコンポーネントのテスト用カスタムフック                    ║
 * ║                                                               ║
 * ╚═══════════════════════════════════════════════════════════════╝
 *
 * このファイルはuseSwitchExコンポーネントのテストページで使用される
 * カスタムフックを定義します。フォーム管理、API実行、コピー機能などを提供します。
 *
 * @file useUnitTest.js
 * @module unit_test/useSwitchEx/useUnitTest
 */
...
const log = new logjs("unit_test_formEx/useSwitchEx/useUnitTest");
const api = new apijs("api/test");

/**
 * useSwitchExのテスト用カスタムフック
