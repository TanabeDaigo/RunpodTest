 ...
 * ╔═══════════════════════════════════════════════════════════════╗
 * ║                                                               ║
 * ║   MetroJS - useCheckBoxEx Unit Test Hook                          ║
 * ║   Copyright (c) 2024 Metro Digital Solutions                  ║
 * ║                                                               ║
 * ║   useCheckBoxExコンポーネントのテスト用カスタムフック                    ║
 * ║                                                               ║
 * ╚═══════════════════════════════════════════════════════════════╝
 *
 * このファイルはuseCheckBoxExコンポーネントのテストページで使用される
 * カスタムフックを定義します。フォーム管理、API実行、コピー機能などを提供します。
 *
 * @file useUnitTest.js
 * @module unit_test/useCheckBoxEx/useUnitTest
 */
...
const log = new logjs("unit_test_formEx/useCheckBoxEx/useUnitTest");
const api = new apijs("api/test");

/**
 * useCheckBoxExのテスト用カスタムフック
