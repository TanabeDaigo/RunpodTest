 ...
 * ╔═══════════════════════════════════════════════════════════════╗
 * ║                                                               ║
 * ║   MetroJS - useRadioEx Unit Test Hook                          ║
 * ║   Copyright (c) 2024 Metro Digital Solutions                  ║
 * ║                                                               ║
 * ║   useRadioExコンポーネントのテスト用カスタムフック                    ║
 * ║                                                               ║
 * ╚═══════════════════════════════════════════════════════════════╝
 *
 * このファイルはuseRadioExコンポーネントのテストページで使用される
 * カスタムフックを定義します。フォーム管理、API実行、コピー機能などを提供します。
 *
 * @file useUnitTest.js
 * @module unit_test/useRadioEx/useUnitTest
 */
...
const log = new logjs("unit_test_formEx/useRadioEx/useUnitTest");
const api = new apijs("api/test");

/**
 * useRadioExのテスト用カスタムフック
