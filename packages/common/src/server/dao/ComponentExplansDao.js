...
const log = new logjs("ComponentExplansDao");
 ...
 */
@injectable()
class ComponentExplansDao extends AbstractDao {
  constructor() {
    super("component_explans");
  }
  ...
  async find(params) {
    ...
    try {
      ...
      // テーブル結合の設定
      _sqljs.from(["component_explans co"]);

      // 基本条件：有効なレコードのみ
      _sqljs.where("co.is_deleted = false");
...
export default ComponentExplansDao;
